...
import { ContactPage, Landing, TrustPage } from './pages/Public'
...
export default function App() { return <Suspense fallback={<div className="app-loading">Loading Atlas CertOps…</div>}><Routes>
  <Route path="/" element={<Landing />} /><Route path="/privacy" element={<TrustPage kind="privacy" />} /><Route path="/terms" element={<TrustPage kind="terms" />} /><Route path="/security" element={<TrustPage kind="security" />} /><Route path="/contact" element={<ContactPage />} />
