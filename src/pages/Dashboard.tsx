...
export function Dashboard() {
  ...
  return <>
    <PageHeader eyebrow="Operations overview" title="Good morning, Alex." description="Here’s what can expire or break next across your managed estate." actions={<><button className="button secondary">Export report</button><Link className="button primary" to="/certificates">Add certificate</Link></>} />
